if (interactive()) {
                ...
                type <- "ChemiDPlus Synonyms"

                # Create output variables
                new_col_name <- "Source Each Word ChemiDPlus Synonyms"
                                                                ...
                                                                if (nchar(input_concept) > source_skip_nchar) {
                                                                        ...
                                                                        if (length(Words)) {
                                                                                ...
                                                                                for (j in 1:length(Words)) {
                                                                                        ...
                                                                                        word_resultset <-
                                                                                                synonyms_from_chemidplus(phrase = Words[j])

                                                                                        #if (length(word_resultset) > 0) {

                                                                                        output[[i]][[j]] <-
                                                                                                rubix::vector_to_tibble(vector = cave::vector_to_string(word_resultset),
                                                                                                                        new_col = ChemiDPlus)
                                                                                ...
                                                                                if (n_words > 0) {
                                                                                        ...
                                                                                        output[[i]] <-
                                                                                                ...
                                                                                                dplyr::filter(ChemiDPlus != "c('')") %>%
                                                                                                dplyr::mutate(ChemiDPlus = paste0(Word, ": ", ChemiDPlus)) %>%
                                                                                                dplyr::select(!!new_col_name := ChemiDPlus)
