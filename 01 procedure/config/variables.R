...
#
# cat("origin_fn <- ", origin_fn, "\n", file = setting_history_fn, append = TRUE)
# cat("origin_tab <- ", origin_tab, "\n", file = setting_history_fn, append = TRUE)
# cat("source_col <- ", source_col, "\n", file = setting_history_fn, append = TRUE)
# cat("term_col <- ", term_col, "\n", file = setting_history_fn, append = TRUE)
# cat("terminal_col <- ", terminal_col, "\n", file = setting_history_fn, append = TRUE)
# cat("attribute_col <- ", attribute_col, "\n", file = setting_history_fn, append = TRUE)
#
#
#
