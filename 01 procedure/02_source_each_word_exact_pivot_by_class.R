                ...
                new_col_name <- "Source Each Word Exact Pivot By Class"
                                                                ...
                                                                if (nchar(input_concept) > source_skip_nchar) {
                                                                        ...
                                                                        if (length(Words)) {
                                                                                ...
                                                                                for (j in 1:length(Words)) {
                                                                                        ...
                                                                                        if (nrow(word_resultset) > 0) {


                                                                                                output[[i]][[j]] <-
                                                                                                        chariot::pivot_relative(word_resultset %>%
                                                                                                                                dplyr::mutate(concept_id = as.integer(concept_id)) %>%
                                                                                                                                             dplyr::select(exact_resultset_id = concept_id),
                                                                                                                                names_from = "concept_class_id") %>%
                                                                                                        rubix::cleanup_colnames() %>%
                                                                                                        rubix::rename_all_prefix("routine_")
