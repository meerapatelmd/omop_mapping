...
# Routine Variables
type <- c("like")
new_col_name <- paste0("Source Terms In Parentheses ", centipede::in_title_format(type))
                                                                ...
                                                                if (nchar(input_concept) > source_skip_nchar) {
                                                                        ...
                                                                        if (grepl("[(]{1}", input_concept)) {
                                                                                        ...
                                                                                        if (grepl("[,]", FirstWord)) {
                                                                                                ...
                                                                                                AllTerms <- strsplit(FirstWord, split = ",") %>%
                                                                                                                        unlist() %>%
                                                                                                                        trimws("both") %>%
                                                                                                                        unique()

                                                                                                secretary::typewrite(crayon::bold("Concept:"), input_concept)
                                                                                                secretary::typewrite(crayon::bold("Concepts inside Parentheses:"), FirstWord)
                                                                                                secretary::typewrite(crayon::bold("Subconcepts:"))
                                                                                                ...
                                                                                                output[[i]] <-
                                                                                                        dplyr::bind_rows(output[[i]], .id = "Source Term") %>%
                                                                                                        chariot::merge_concepts(into = `Concept`) %>%
                                                                                                        dplyr::mutate(Concept = paste0(`Source Term`, ": ", Concept)) %>%
