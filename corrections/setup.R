if ("/Users/patelm9/GitHub/KMI/termite/Map_to_OMOP/corrections" != getwd()) {
        setwd("/Users/patelm9/GitHub/KMI/termite/Map_to_OMOP/corrections")
}

source('utils.R')

# Project Setup
origin_fn <-  "~/Memorial Sloan Kettering Cancer Center/KM COVID - General/Mappings/Complete Forms/COVID_Meera_complete.xlsx"
origin_terminal_tab <- "Sheet1"
input_file_stem <- "COVID_Meera_complete_post_qa_"
