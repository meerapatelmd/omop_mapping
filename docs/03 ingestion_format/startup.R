rm(list = ls())
source('/Users/patelm9/GitHub/omop_mapping/03 ingestion_format/config/funs.R')
set_this_wd()
source('/Users/patelm9/GitHub/omop_mapping/03 ingestion_format/config/constants.R')
source('/Users/patelm9/GitHub/omop_mapping/03 ingestion_format/config/variables.R')
