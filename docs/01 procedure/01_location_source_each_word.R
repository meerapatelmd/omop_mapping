if (interactive()) {
                ...
                new_col_name <- "Source Each Word Location"
                                                                ...
                                                                if (nchar(input_concept) > source_skip_nchar) {
                                                                        ...
                                                                        if (length(Words)) {
                                                                                ...
                                                                                for (j in 1:length(Words)) {
                                                                                        ...
                                                                                        word_resultset <-
                                                                                                chariot::locate_phrase(phrase = Words[j])

                                                                                        output[[i]][[j]] <-
                                                                                                rubix::vector_to_tibble(vector = word_resultset,
                                                                                                                        new_col = Location)
                                                                                ...
                                                                                if (n_words > 0) {
                                                                                        ...
                                                                                        output[[i]] <-
                                                                                                ...
                                                                                                dplyr::mutate(Location = paste0(Word, ": ", Location)) %>%
                                                                                                dplyr::select(!!new_col_name := Location)
