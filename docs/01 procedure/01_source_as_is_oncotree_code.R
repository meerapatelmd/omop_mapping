if (interactive()) {
                ...
                new_col_name <- "Source Exact OncoTree Name"
                new_col_name2 <- "Source Exact OncoTree UMLS CUI"
                ...
                # input2 <-
                #         input2 %>%
                #         dplyr::filter(VARIABLE == "Oncotree Code")
                                                ...
                                                # Search if output concept is NA, meaning unmapped
                                                 if (is.na(output_concept)) {
                                                                ...
                                                                # Search if input concept is above the character number threshold
                                                                        ...
                                                                        pre_output <-
                                                                                OncoSeed::search_tumor_types(type = "code",
                                                                                                             search = input_concept)

                                                                        if (is.data.frame(pre_output)) {


                                                                                        output[[i]] <-
                                                                                                pre_output %>%
                                                                                                dplyr::select(!!new_col_name := name)
